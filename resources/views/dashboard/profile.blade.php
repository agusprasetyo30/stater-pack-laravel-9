		...
		<div class="section-body">
            ...
            <p class="section-lead">
							...
							<div class="card-body">
								...
								<div class="row">
									...
									<div class="form-group col-md-12 col-12">
										...
										<input type="password" name="password_confirmation" class="form-control @error('password_confirmation', 'updatePassword') is-invalid @enderror">
				...
				<div class="col-12 col-md-12 col-lg-7">
					<div class="card">
						<form method="post" class="needs-validation" action="{{ route('user-profile-information.update') }}">
							@method('put')
							@csrf
							<div class="card-header">
							<h4>Edit Profile</h4>
							...
							<div class="card-body">
								<div class="row">
									...
									<div class="form-group col-md-6 col-12">
										<label>Email</label>
										<input type="email" name="email" class="form-control  @error('email', 'updateProfileInformation') is-invalid @enderror" value="{{ auth()->user()->email }}">
